  ...
  return (
    <div className="space-y-0.5">
      <div className="flex justify-between items-center">
        <span className="text-[10px] font-bold tracking-widest uppercase text-[#00d4ff]">
          EXP
        </span>
      ...
      <div className="flex gap-[2px] h-[8px] relative">
        {Array.from({ length: SEGMENTS }).map((_, i) => {
          ...
          // Gradient from cyan to purple across segments
          const hue = isFilled ? 190 + (i / SEGMENTS) * 80 : 0;
          return (
            <motion.div
              key={i}
              ...
              className={`flex-1 rounded-[1px] ${!isFilled ? "bg-[#1a2030]" : ""}`}
              style={isFilled ? {
