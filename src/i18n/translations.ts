const translations = {
  en: {
    ...
    // Health
    "health.title": "SYSTEM STABILITY REPORT",
    "health.scanning": "Analyzing entropy...",
    "health.complexity": "Complexity",
    "health.coverage": "Coverage",
    "health.cleanliness": "Cleanliness",
    "health.fileSize": "File Size",
    "health.complexFunctions": "Cognitive Load Hotspots",
    "health.untestedFiles": "Untested Modules",
    "health.anomalies": "Unresolved Markers",
    "health.largeFiles": "Large Modules",
    "health.lines": "lines",
    "health.noIssues": "All nominal",
    "health.error": "Analysis failed",
    "health.stabilize": "[VIEW_FULL_REPORT]",
    "health.alertDismissed": "[REPORT_ACKNOWLEDGED]",
    "health.alertStabilityReport":
      "[SYSTEM_STABILITY_REPORT]: Entropy analysis complete for sector `{sector}`. Areas with elevated cognitive load identified.",
    "health.alertFileSize": "{count} module(s) exceed recommended line count (500+)",
    "health.alertComplexity":
      "{count} function(s) with elevated cognitive complexity (100+ lines)",
    "health.alertScoreLow": "{category} index at {value}/100",
    "health.alertBugMarkers":
      "{count} unresolved BUG/FIXME marker(s) requiring attention",
    "health.alertStabilize": "Review recommended — open full stability report?",
    "health.alertReviewRecommended": "Informational — no immediate action required.",
    ...
    "refinery.new": "new",
    "refinery.signals": "Signals",
    "refinery.pollNow": "POLL NOW",
    "refinery.polling": "POLLING...",
    "refinery.dismiss": "Dismiss",
    "refinery.link": "Link to file",
    "refinery.providers": "Providers",
    "refinery.source.GITHUB": "GitHub",
    "refinery.source.JIRA": "Jira",
    "refinery.source.SLACK": "Slack",
    "refinery.source.TELEGRAM": "Telegram",
    "refinery.priority.1": "CRITICAL",
    "refinery.priority.2": "HIGH",
    "refinery.priority.3": "MEDIUM",
    "refinery.priority.4": "LOW",
    "refinery.priority.5": "NOISE",
    "activity.refinerySignal":
      "[SIG_INT]: {count} new external signal(s) intercepted. Queuing for triage...",
    "bridge.signalSource.GITHUB": "GITHUB",
    "bridge.signalSource.JIRA": "JIRA",
    "bridge.signalSource.SLACK": "SLACK",
    "settings.refinerySection": "Signal Refinery",
    "settings.githubToken": "GitHub Token",
    "settings.githubTokenHint":
      "Personal access token from github.com/settings/tokens. Needs repo scope.",
    "settings.githubOwner": "Repository Owner",
    "settings.githubOwnerHint":
      "GitHub username or organization. Auto-detected from git remote if empty.",
    "settings.githubRepo": "Repository Name",
    "settings.githubRepoHint":
      "Repository name. Auto-detected from git remote if empty.",
    "settings.githubEnabled": "Enable GitHub polling",
    "settings.githubPollInterval": "Poll Interval (seconds)",
    // Jira settings
    "settings.jiraSection": "Jira",
    "settings.jiraBaseUrl": "Jira Base URL",
    "settings.jiraBaseUrlHint": "Your Jira instance URL (e.g. https://myteam.atlassian.net).",
    "settings.jiraEmail": "Jira Email",
    "settings.jiraEmailHint": "Email associated with your Jira account.",
    "settings.jiraApiToken": "Jira API Token",
    "settings.jiraApiTokenHint": "API token from id.atlassian.com/manage-profile/security/api-tokens.",
    "settings.jiraEnabled": "Enable Jira polling",
    "settings.jiraPollInterval": "Jira Poll Interval (seconds)",
    // Slack settings
    "settings.slackSection": "Slack",
    "settings.slackBotToken": "Slack Bot Token",
    "settings.slackBotTokenHint": "Bot token from api.slack.com/apps. Needs channels:history, channels:read scopes.",
    "settings.slackChannels": "Slack Channels",
    "settings.slackChannelsHint": "Comma-separated channel names to monitor (e.g. dev,alerts). Leave empty to auto-discover.",
    "settings.slackEnabled": "Enable Slack polling",
    "settings.slackPollInterval": "Slack Poll Interval (seconds)",
    // Activity — source-specific signals
    "activity.slackSignal": "[SIG_INT]: {count} new signal(s) from Slack. Analyzing context...",
    "activity.jiraSignal": "[SIG_INT]: {count} Jira issue(s) updated. Correlating with project sectors...",
    "activity.criticalSignal":
      "[CRITICAL_SIGNAL_INTERCEPTED]: High probability of conflict in sector '{sector}'. Recommend immediate review.",
    // AI Triage
    "settings.aiTriageEnabled": "Enable AI Signal Triage",
    "settings.aiTriageHint": "Automatically score and prioritize incoming signals using the configured AI model.",
    "settings.hideLowPriority": "Hide Low-Priority Signals",
    "settings.hideLowPriorityHint": "Hide signals below level 3 (Low and Noise) from the timeline.",
  ...
  ru: {
    ...
    // Health
    "health.title": "ОТЧЁТ О СТАБИЛЬНОСТИ",
    "health.scanning": "Анализ энтропии...",
    "health.complexity": "Сложность",
    "health.coverage": "Покрытие",
    "health.cleanliness": "Чистота",
    "health.fileSize": "Размер файлов",
    "health.complexFunctions": "Участки когнитивной нагрузки",
    "health.untestedFiles": "Непротестированные модули",
    "health.anomalies": "Нерешённые маркеры",
    "health.largeFiles": "Крупные модули",
    "health.lines": "строк",
    "health.noIssues": "Всё в норме",
    "health.error": "Ошибка анализа",
    "health.stabilize": "[ПОЛНЫЙ_ОТЧЁТ]",
    "health.alertDismissed": "[ОТЧЁТ_ПРИНЯТ]",
    "health.alertStabilityReport":
      "[SYSTEM_STABILITY_REPORT]: Анализ энтропии завершён для сектора `{sector}`. Выявлены участки с повышенной когнитивной нагрузкой.",
    "health.alertFileSize": "{count} модуль(ей) превышают рекомендуемый объём (500+ строк)",
    "health.alertComplexity": "{count} функций с повышенной когнитивной сложностью (100+ строк)",
    "health.alertScoreLow":
      "Индекс «{category}»: {value}/100",
    "health.alertBugMarkers":
      "{count} нерешённых маркеров BUG/FIXME, требующих внимания",
    "health.alertStabilize": "Рекомендуется проверка — открыть полный отчёт о стабильности?",
    "health.alertReviewRecommended": "Информационное уведомление — немедленных действий не требуется.",
    ...
    // Signal Refinery
    "refinery.title": "РЕФАЙНЕРИ",
    "refinery.new": "новых",
    "refinery.signals": "Сигналы",
    "refinery.pollNow": "ОПРОС",
    "refinery.polling": "ОПРОС...",
    "refinery.dismiss": "Отклонить",
    "refinery.link": "Привязать к файлу",
    "refinery.providers": "Провайдеры",
    "refinery.source.GITHUB": "GitHub",
    "refinery.source.JIRA": "Jira",
    "refinery.source.SLACK": "Slack",
    "refinery.source.TELEGRAM": "Telegram",
    "refinery.priority.1": "КРИТИЧНО",
    "refinery.priority.2": "ВЫСОКИЙ",
    "refinery.priority.3": "СРЕДНИЙ",
    "refinery.priority.4": "НИЗКИЙ",
    "refinery.priority.5": "ШУМ",
    "activity.refinerySignal":
      "[SIG_INT]: Перехвачено {count} новых внешних сигнал(ов). Постановка в очередь на триаж...",
    "bridge.signalSource.GITHUB": "GITHUB",
    "bridge.signalSource.JIRA": "JIRA",
    "bridge.signalSource.SLACK": "SLACK",
    "settings.refinerySection": "Signal Refinery",
    "settings.githubToken": "Токен GitHub",
    "settings.githubTokenHint":
      "Персональный токен с github.com/settings/tokens. Нужен scope repo.",
    "settings.githubOwner": "Владелец репозитория",
    "settings.githubOwnerHint":
      "Имя пользователя или организации GitHub. Автоопределение из git remote, если пусто.",
    "settings.githubRepo": "Имя репозитория",
    "settings.githubRepoHint":
      "Имя репозитория. Автоопределение из git remote, если пусто.",
    "settings.githubEnabled": "Включить опрос GitHub",
    "settings.githubPollInterval": "Интервал опроса (секунды)",
    // Jira settings
    "settings.jiraSection": "Jira",
    "settings.jiraBaseUrl": "Базовый URL Jira",
    "settings.jiraBaseUrlHint": "URL вашего инстанса Jira (напр. https://myteam.atlassian.net).",
    "settings.jiraEmail": "Email Jira",
    "settings.jiraEmailHint": "Email, привязанный к вашему аккаунту Jira.",
    "settings.jiraApiToken": "API-токен Jira",
    "settings.jiraApiTokenHint": "API-токен с id.atlassian.com/manage-profile/security/api-tokens.",
    "settings.jiraEnabled": "Включить опрос Jira",
    "settings.jiraPollInterval": "Интервал опроса Jira (секунды)",
    // Slack settings
    "settings.slackSection": "Slack",
    "settings.slackBotToken": "Токен бота Slack",
    "settings.slackBotTokenHint": "Токен бота с api.slack.com/apps. Нужны scope: channels:history, channels:read.",
    "settings.slackChannels": "Каналы Slack",
    "settings.slackChannelsHint": "Имена каналов через запятую (напр. dev,alerts). Оставьте пустым для автоопределения.",
    "settings.slackEnabled": "Включить опрос Slack",
    "settings.slackPollInterval": "Интервал опроса Slack (секунды)",
    // Activity — source-specific signals
    "activity.slackSignal": "[SIG_INT]: Перехвачено {count} сигнал(ов) из Slack. Анализ контекста...",
    "activity.jiraSignal": "[SIG_INT]: Обновлено {count} задач(а) в Jira. Корреляция с секторами проекта...",
    "activity.criticalSignal":
      "[CRITICAL_SIGNAL_INTERCEPTED]: Высокая вероятность конфликта в секторе '{sector}'. Рекомендуется немедленная проверка.",
    // AI Triage
    "settings.aiTriageEnabled": "Включить ИИ-триаж сигналов",
    "settings.aiTriageHint": "Автоматически оценивать и приоритизировать входящие сигналы с помощью настроенной ИИ-модели.",
    "settings.hideLowPriority": "Скрыть сигналы низкого приоритета",
    "settings.hideLowPriorityHint": "Скрыть сигналы ниже 3 уровня (Низкий и Шум) из таймлайна.",
